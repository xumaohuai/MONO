...
@property (nonatomic, strong) YYAnimatedImageView *imageView;   //显示的图片
...
//        self.imageView.image = model.image;
        if([[YYImageCache sharedCache]containsImageForKey:model.url.absoluteString]){
            self.imageView.image = [[YYImageCache sharedCache]getImageForKey:model.url.absoluteString];
        }else{
            self.imageView.yy_imageURL = model.url;
        }
