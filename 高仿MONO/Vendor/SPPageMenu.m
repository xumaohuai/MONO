...
- (CGRect)imageRectForContentRect:(CGRect)contentRect {
    if (!self.currentTitle.length) { // 如果没有文字，则图片占据整个button，空格算一个文字
...
- (void)initialize {
    ...
    _selectedItemTitleColor = [UIColor colorWithRed:0.09 green:0.6 blue:0.64 alpha:1];
    _unSelectedItemTitleColor = [UIColor colorWithRed:0.98 green:0.98 blue:1 alpha:1];
    _trackerHeight = 2;
...
- (void)layoutSubviews {
    ...
    self.itemScrollView.contentSize = CGSizeMake(lastButtonMaxX+20, 0);
