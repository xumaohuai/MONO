...
-(void)setupView
{
    ...
    _readSwith = [[MBSwitch alloc]initWithFrame:CGRectMake(200, 20, 28, 16)];
...
//    _readSwith.backgroundColor = [UIColor blackColor];
    ...
    _readSwith.sd_layout.rightSpaceToView(_backgroudView, 10).centerYIs((self.height + topHeight) /2).widthIs(28).heightIs(16);
